...
English ([en](en.js)), German ([de](de.js)), Finnish ([fi](fi.js)), French ([fr](fr.js)), Brazilian Portuguese ([pt-br](pt-br.js)), Russian ([ru](ru.js)) and Spanish ([es](es.js)) are currently the only supported locales. Pull requests welcome.
